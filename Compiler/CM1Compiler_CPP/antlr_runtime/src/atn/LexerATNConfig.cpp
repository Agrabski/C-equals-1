...
LexerATNConfig::LexerATNConfig(LexerATNConfig const& c, ATNState* state)
...
LexerATNConfig::LexerATNConfig(LexerATNConfig const& c, ATNState* state, Ref<LexerActionExecutor> const& lexerActionExecutor)
	: ATNConfig(c, state, c.context, c.semanticContext), _lexerActionExecutor(lexerActionExecutor),
	_passedThroughNonGreedyDecision(checkNonGreedyDecision(c, state)) {
}

LexerATNConfig::LexerATNConfig(LexerATNConfig const& c, ATNState* state, Ref<PredictionContext> const& context)
