...
namespace antlr4 {
	namespace atn {
		...
		public:
			...
			ATNConfig(ATNConfig const& c); // dup
			ATNConfig(ATNConfig const& c, ATNState* state);
			ATNConfig(ATNConfig const& c, ATNState* state, Ref<SemanticContext> const& semanticContext);
			ATNConfig(ATNConfig const& c, Ref<SemanticContext> const& semanticContext);
			ATNConfig(ATNConfig const& c, ATNState* state, Ref<PredictionContext> const& context);
			ATNConfig(ATNConfig const& c, ATNState* state, Ref<PredictionContext> const& context, Ref<SemanticContext> const& semanticContext);
