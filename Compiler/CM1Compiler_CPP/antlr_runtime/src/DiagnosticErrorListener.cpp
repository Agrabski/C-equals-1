...
{
	auto const decision = dfa.decision;
	auto const ruleIndex = (reinterpret_cast<atn::ATNState*>(dfa.atnStartState))->ruleIndex;

	const auto& ruleNames = recognizer->getRuleNames();
