...
std::unique_ptr<cMCompiler::dataStructures::execution::ReferenceValue> cMCompiler::language::heapAllocate(gsl::not_null<dataStructures::Type*> type, bool unique)
{
...
{
	auto reference = heapAllocate(type, unique);
