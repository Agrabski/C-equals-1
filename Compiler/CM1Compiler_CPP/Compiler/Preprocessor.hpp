...
namespace cMCompiler::compiler
{
	...
	public:
		...
		Preprocessor(dataStructures::PackageDatabase& database, std::filesystem::path const& filePath, language::NameResolver& nameResolver, language::NameResolutionContext& context, bool ignoreGenerics = true) noexcept :
			database_(database), nameResolver_(nameResolver), context_(context), filePath_(filePath), ignoreGenerics_(ignoreGenerics)
		{
		}
