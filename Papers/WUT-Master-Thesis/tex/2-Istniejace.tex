...
W związku z tym niektóre typy optymalizacji takie jak \lstinline{inlining} (bezpośrednie użycie ciała funkcji, zamiast jej wywołania) nie są możliwe.%todo: source. this is promising https://github.com/dotnet/csharplang/discussions/1413 but for fuck sake i cant qoute it
