...
Atrybuty powiązane z parametrami funkcji mają być traktowane jako wymagania na wartościach przekazywanych przy jej wywołaniu. %todo: think more
...
%todo:finish
%todo: talk about errors in java type erasure
