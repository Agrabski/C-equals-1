...
Listing \ref{lst:extern_cm1} przedstawia przykład atrybut oznaczającego funkcję jako symbol zewnętrzny.
...
Pakiet \lstinline{CBindings} zawiera atrybut generujący pliki nagłówkowe dla języka C (plik \path{\Libraries\cBindings\src\cBindingsAttribute.cm} w repozytorium z kodem źródłowym).
...
%todo: insert c code using the bindings
