...
Dodatkowe komponenty kompilatora, które zostały wydzielone to: \emph{Interpreter}, \emph{Serializator} oraz \emph{Back end Interface}. % todo: italic
...
%todo: wording
%todo: analogia do tego jak człowiek rozumie program
...
W liniach szesnastej i siedemnastej dochodzi do konwersji (ang. marshalling) ze struktur danych interpretera C-=-1 do natywnego obiektu C++. %todo: cite wikipedia
