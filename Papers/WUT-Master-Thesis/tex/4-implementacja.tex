...
Interpreter C-=-1 stanowi środowisko uruchomieniowe, stanowiące dużą warstwę abstrakcji od maszyny, na której jest uruchomiony.
W tym trybie, z perspektywy programisty, nie istnieje stos, a obiekty nie mają ani adresów, ani wielkości.
...
Ten brak wynika z braku czasu i powinien zostać uzupełniony w przyszłej wersji kompilatora.
...
Poza obsługą błędów funkcja \lstinline{execute} przygotowywuje ten typ do wykonania procedury zdefiniowanej przez \lstinline{functionDefinition} oraz śledzi obecnie wykonywaną instrukcję.
